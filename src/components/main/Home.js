                                ...
                                <div className="col-12">
                                    <div className="single-post wow fadeInUp" data-wow-delay=".2s">
                                        ...
                                        <div className="post-content">
                                            ...
                                            <a href="#">
                                                <h2 className="post-headline">Boil The Kettle And Make A Cup Of Tea
                                                    Folks, This Is Going To Be A Big One!</h2>
                                            </a>
                                            <p>Tiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                ...
                                <div className="col-12 col-md-6">
                                    <div className="single-post wow fadeInUp" data-wow-delay=".6s">
                                        ...
                                        <div className="post-content">
                                            ...
                                            <a href="#">
                                                <h4 className="post-headline">The Top Breakfast And Brunch Spots In
                                                    Hove, Brighton</h4>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 col-md-6">
                                    <div className="single-post wow fadeInUp" data-wow-delay=".8s">
                                        ...
                                        <div className="post-content">
                                            ...
                                            <a href="#">
                                                <h4 className="post-headline">The 10 Best Pubs In The Lake District,
                                                    Cumbria</h4>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 col-md-6">
                                    <div className="single-post wow fadeInUp" data-wow-delay="1s">
                                        ...
                                        <div className="post-content">
                                            ...
                                            <a href="#">
                                                <h4 className="post-headline">The 10 Best Brunch Spots In Newcastle,
                                                    England</h4>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12">
                                    <div className="list-blog single-post d-sm-flex wow fadeInUpBig"
                                        ...
                                        <div className="post-content">
                                            ...
                                            <a href="#">
                                                <h4 className="post-headline">The 10 Best Bars By The Seaside In
                                                    Blackpool, UK</h4>
                                            </a>
                                            <p>Tiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                ...
                                <div className="col-12">
                                    <div className="list-blog single-post d-sm-flex wow fadeInUpBig"
                                        ...
                                        <div className="post-content">
                                            ...
                                            <a href="#">
                                                <h4 className="post-headline">How To Get a Narcissist to Feel
                                                    Empathy</h4>
                                            </a>
                                            <p>Tiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                                minim veniam, quis nostrud exercitation</p>
                                ...
                                <div className="col-12">
                                    <div className="list-blog single-post d-sm-flex wow fadeInUpBig"
                                        ...
                                        <div className="post-content">
                                            ...
                                            <a href="#">
                                                <h4 className="post-headline">Bristol's 10 Amazing Weekend Brunches And
                                                    Late Breakfasts</h4>
                                            </a>
                                            <p>Tiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                                minim veniam, quis nostrud exercitation</p>
                                ...
                                <div className="col-12">
                                    <div className="list-blog single-post d-sm-flex wow fadeInUpBig"
                                        ...
                                        <div className="post-content">
                                            ...
                                            <a href="#">
                                                <h4 className="post-headline">10 Of The Best Places To Eat In Liverpool,
                                                    England</h4>
                                            </a>
                                            <p>Tiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                                minim veniam, quis nostrud exercitation</p>
